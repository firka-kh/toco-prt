...
const ResumesPage = () => <div className="min-h-screen flex items-center justify-center">
  <h1 className="text-2xl">Страница поиска резюме - в разработке</h1>
</div>;
...
const ContactPage = () => <div className="min-h-screen flex items-center justify-center">
  <h1 className="text-2xl">Страница контактов - в разработке</h1>
</div>;
